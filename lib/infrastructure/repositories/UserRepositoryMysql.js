...
module.exports = class extends UserRepository {
    ...
    async createUser(name, lastName, email, password, birthDate, gender) {
        let sqlQuery = "INSERT INTO Users (name, lastName, email, password, birthDate, gender) VALUES (?,?,?,?,?,?)";
        connection.query(sqlQuery, [name, lastName, email, password, birthDate, gender]).spread((response) => console.log(response));
    }
